...
export async function getDoctorDashboardStats() {
  try {
    ...
    // const availableDoctors = doctors.slice(0, 5);---choose 5 doctors using take method
    // console.log("available doctors", doctors);--- debugging statement for available doctors
