...
import { ViewAction } from '@/components/action-option';
...
const DoctorsList = async (props: SearchParamsProps) => {
  ...
  if (!data) return null;
  // console.log(data, totalPages, totalRecords, currentPage);-- for debugging purposes to check if the data is being fetched correctly
