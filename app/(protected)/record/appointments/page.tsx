import { AppointmentActionOptions } from "@/components/appointment-action-options";
import { AppointmentContainer } from "@/components/appointment-container";
// import AppointmentContainer from "@/components/appointment-container";---disturbance
...
const Appointments = async (props: {
  ...
  //checking if data is visible or not through the console log
// console.log("data", data);
//checking if data is empty or null
  if (!data) return null;
